        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            ...
            <div>
              <a
                href="#!"
                className="disabled:opacity-75 w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
              >
            ...
            <div>
              ...
              >
                ...
                <img
                  src="https://cdn-icons-png.flaticon.com/512/281/281747.png"
